...
async function makeArtistIdNullableInBrandings() {
  try {
    console.log('🔄 Making artist_id nullable in artist_brandings table...');
    ...
    console.log('✅ artist_id is now nullable in artist_brandings table');
  } catch (error) {
...
if (require.main === module) {
  makeArtistIdNullableInBrandings()
    .then(() => {
...
module.exports = makeArtistIdNullableInBrandings;
